...
⚡ [**go-twitch-eventsub**](https://github.com/joeyak/go-twitch-eventsub) ![Stars](https://img.shields.io/github/stars/joeyak/go-twitch-eventsub?style=social) - a Go client for Twitch's EventSub API, used to power Mr Moo Bot.

🧾 [**go-escpos**](https://github.com/joeyak/go-escpos) ![Stars](https://img.shields.io/github/stars/joeyak/go-escpos?style=social) - a library to interface with receipt printers using the ESC/POS command set. Why make it? Why not!
